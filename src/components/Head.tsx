...
const Head = () => {
  ...
  return (
    <div className="grid grid-flow-col p-5 shadow-lg shadow-gray-300">
      ...
      <div className="grid-cols-10">
        <input
          type="text"
          className="w-10/12 border border-gray-300 rounded-l-full p-1"
        />
        <button className="border border-gray-300 rounded-r-full px-3 py-1 bg-gray-200">
          🔍
        </button>
      </div>
